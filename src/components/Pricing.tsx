export default function Pricing() {
  return (
    <section id="pricing" aria-label="Pricing" className="bg-bone-white px-6 py-24 md:py-36">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2" data-reveal-stagger>
          {/* Standard lesson */}
          <article data-tilt className="flex flex-col border border-asphalt-950/15 bg-white p-8 md:p-12">
            <h3 className="display text-2xl text-asphalt-950">Standard Lesson</h3>
            <p className="mt-6">
              <span className="display text-6xl text-asphalt-950">£45</span>
          ...
          {/* GO 10 — best value */}
          <article data-tilt className="relative flex flex-col border-2 border-go-600 bg-white p-8 md:p-12">
            ...
            <p className="mt-6">
              <span className="display text-6xl text-asphalt-950">£445</span>
