...
export default function Lessons() {
  return (
    <section id="lessons" aria-label="Our lessons" className="bg-asphalt-900 px-0 py-24 md:py-36">
      ...
      <div className="mt-14 md:mx-auto md:max-w-7xl md:px-6">
        <div
        ...
        >
          {LESSONS.map((lesson) => (
            <article
              key={lesson.kicker}
              className="group relative flex w-[86vw] max-w-md flex-none flex-col border-t-4 border-go-500 bg-bone-white p-8 transition-[transform,box-shadow] duration-300 hover:-translate-y-1.5 hover:shadow-[0_22px_44px_-18px_rgba(141,198,63,0.55)] md:w-auto md:max-w-none md:p-12"
            >
              ...
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-asphalt-500 md:text-base">
